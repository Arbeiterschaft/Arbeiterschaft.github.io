...
- **Platform:** [e.g. STM32F4]
- **Stack:** [e.g. C, FreeRTOS, ROS2]
- **Sensors:** [e.g. IMU, LIDAR, encoders]
- **Comms:** [e.g. CAN bus, I2C, UART]
- **Duration:** [e.g. 3 months, solo / team of 4]
- **Status:** [e.g. Deployed / Prototype / Competition]
